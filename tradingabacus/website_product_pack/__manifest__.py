...
#################################################################################
{
  ...
  "live_test_url"        :  "http://odoodemo.webkul.com/?module=website_product_pack&version=16.0",
  "depends"              :  [
                             'wk_product_pack',
                             'website_sale',
                            ],
  ...
  'assets'               :  {
                                'web.assets_frontend': [
                                    'website_product_pack/static/src/css/website_product_pack.css',
                                    'website_product_pack/static/src/js/website_pack_product.js'
                            ]},
  "application"          :  True,
  "installable"          :  True,
  "auto_install"         :  False,
